...
namespace CpuDeckBuilder
{
    ...
    public sealed class CpuDeckBuilderPresenter : MonoBehaviour, IStartable
    {
        ...
        private readonly DeckModel _deckModel = new DeckModel();
        ...
        private void RefreshDeckPanel()
        {
            ...
            _saveButton.SetEnabled(_deckModel.IsReady);
