...
namespace Main.Card
{
    ...
    public sealed class CharacterCardSO : ScriptableObject
    {
...
#if UNITY_EDITOR
        // 所属カードの属性を SO の属性に揃えたうえで、属性ごとに C#### を自動採番する
        ...
        public void EditorSetCards(CardAttribute attribute, List<CharacterCardData> cards)
        {
            _attribute = attribute;
            _cards = cards;
            ApplyAttributeToCards();
            CardIdAutoAssigner.AssignIds(_cards, "C");
        }
#endif
    }
}
