...
- 誘導つきスクリプト対戦（カードの見方／基本／攻撃／勝ち方3種／キーワード能力8種）→ [architecture.md](architecture.md)「チュートリアル」・[MainPresenter.Tutorial.cs](../Assets/Scripts/Main/MainPresenter.Tutorial.cs)
