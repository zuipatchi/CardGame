...
| サウンド再生（BGM/SE/ボイス読み上げ。PlayVoice は前の読み上げを停止して再生） | [Assets/Scripts/Common/SoundManagement/SoundPlayer.cs](Assets/Scripts/Common/SoundManagement/SoundPlayer.cs) |
...
| Main Presenter（メインフェーズ・CPU選択） | [Assets/Scripts/Main/MainPresenter.Phases.Main.cs](Assets/Scripts/Main/MainPresenter.Phases.Main.cs) |
| Main Presenter（攻撃・デッキ攻撃・ミル・墓地飛行） | [Assets/Scripts/Main/MainPresenter.Phases.Main.Attack.cs](Assets/Scripts/Main/MainPresenter.Phases.Main.Attack.cs) |
