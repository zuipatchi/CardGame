...
| カードID自動採番（Editor 専用） | [Assets/Scripts/Main/Card/CardIdAutoAssigner.cs](Assets/Scripts/Main/Card/CardIdAutoAssigner.cs) |
...
| ハートライフ UI（勝利条件） | [Assets/Scripts/Main/Card/LifeHeartsView.cs](Assets/Scripts/Main/Card/LifeHeartsView.cs) |
| 勝利点 UI（緑属性の勝利条件） | [Assets/Scripts/Main/Card/VictoryPointsView.cs](Assets/Scripts/Main/Card/VictoryPointsView.cs) |
...
| ハート勝利条件ルール | [Assets/Scripts/Main/Game/HeartRule.cs](Assets/Scripts/Main/Game/HeartRule.cs) |
| 青属性勝利条件ルール（デッキ0勝利） | [Assets/Scripts/Main/Game/BlueRule.cs](Assets/Scripts/Main/Game/BlueRule.cs) |
| 緑属性勝利条件ルール（勝利点20勝利） | [Assets/Scripts/Main/Game/GreenRule.cs](Assets/Scripts/Main/Game/GreenRule.cs) |
