...
| 付与キーワード能力 enum（GrantKeyword の値2対応・守護/速攻/飛行/防人/強襲/デッキ攻撃×/射手/必殺） | [Assets/Scripts/Main/Card/GrantableKeyword.cs](Assets/Scripts/Main/Card/GrantableKeyword.cs) |
