...
| サウンド再生（BGM/SE/ボイス読み上げ。PlayVoice は前の読み上げを止めず重ねて再生。PlaySE は SE ごとの正規化倍率を掛けて再生） | [Assets/Scripts/Common/SoundManagement/SoundPlayer.cs](Assets/Scripts/Common/SoundManagement/SoundPlayer.cs) |
