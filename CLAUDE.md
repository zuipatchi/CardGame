...
| Main Presenter（チュートリアル：誘導つきスクリプト対戦。固定デッキ・盤面プリセット・台本CPU・コーチ吹き出し・クリア演出） | [Assets/Scripts/Main/MainPresenter.Tutorial.cs](Assets/Scripts/Main/MainPresenter.Tutorial.cs) |
