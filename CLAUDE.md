...
| 技カード効果種別 | [Assets/Scripts/Main/Card/SkillType.cs](Assets/Scripts/Main/Card/SkillType.cs) |
...
| 戦闘計算（属性・ATK） | [Assets/Scripts/Main/Game/BattleCalculator.cs](Assets/Scripts/Main/Game/BattleCalculator.cs) |
...
| Main Presenter（PreBattle1/2フェーズ） | [Assets/Scripts/Main/MainPresenter.Phases.PreBattle.cs](Assets/Scripts/Main/MainPresenter.Phases.PreBattle.cs) |
