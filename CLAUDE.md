...
| Main Presenter（メインフェーズ・CPU選択・CPU難易度（中級以上は CostBoost／ダメージトリガー持ちを場に出さずコストに回す）・タップ/アンタップ・攻撃可否判定） | [Assets/Scripts/Main/MainPresenter.Phases.Main.cs](Assets/Scripts/Main/MainPresenter.Phases.Main.cs) |
